...
public interface NotificationRepository extends JpaRepository<Notification, Integer> {
    ...
    @Query("""
           ...
           """)
    List<Notification> searchForAccount(@Param("accountId") Integer accountId,
    ...
    @Query("""
           ...
           order by n.createdAt desc, n.id desc
           """)
    List<Notification> findActiveForAccount(@Param("accountId") Integer accountId);
    ...
    @Query("""
           ...
           limit 5
           """)
    List<Notification> findTop5ActiveForAccount(@Param("accountId") Integer accountId);
    ...
    @Query("""
           ...
           """)
    Optional<Notification> findByIdAndAccountId(@Param("notificationId") Integer notificationId,
